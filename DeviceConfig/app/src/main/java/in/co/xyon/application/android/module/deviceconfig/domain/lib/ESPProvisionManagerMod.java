...
import com.espressif.provisioning.CameraSourcePreview;
 ...
 * object of ESPDevice.
 */
public class ESPProvisionManagerMod {

    private static final String TAG = "ESP:" + ESPProvisionManagerMod.class.getSimpleName();

    private static ESPProvisionManagerMod provision;

    private ESPDeviceMod espDevice;
     ...
     * @return Returns
     */
    public static ESPProvisionManagerMod getInstance(Context context) {

        if (provision == null) {
            provision = new ESPProvisionManagerMod(context);
        }
        return provision;
    }

    private ESPProvisionManagerMod(Context context) {
     ...
     */
    public ESPDeviceMod createESPDevice(ESPConstants.TransportType transportType, ESPConstants.SecurityType securityType) {

        espDevice = new ESPDeviceMod(context, transportType, securityType);
        return espDevice;
    }
     ...
     * @return Returns ESPDevice.
     */
    public ESPDeviceMod getEspDevice() {
        return espDevice;
    }
     ...
     * @param qrCodeScanListener  QRCodeScanListenerMod
     */
    ...
    public void scanQRCode(final Activity activityContext, final CameraSourcePreview cameraSourcePreview, final QRCodeScanListenerMod qrCodeScanListener) {
     ...
     */
    @RequiresPermission(allOf = {Manifest.permission.CAMERA, Manifest.permission.BLUETOOTH_ADMIN, Manifest.permission.BLUETOOTH, Manifest.permission.ACCESS_FINE_LOCATION})
    public void scanQRCode(final CodeScanner codeScanner, final QRCodeScanListenerMod qrCodeScanListener) {
     ...
     * @param qrCodeScanListener QRCodeScanListenerMod for callbacks.
     */
    @RequiresPermission(allOf = {Manifest.permission.CAMERA, Manifest.permission.BLUETOOTH_ADMIN, Manifest.permission.BLUETOOTH, Manifest.permission.ACCESS_FINE_LOCATION})
    public void scanQRCode(final PreviewView cameraPreview, Activity activityContext, final QRCodeScanListenerMod qrCodeScanListener) {
    ...
    private void processQrCode(String qrCode, QRCodeScanListenerMod qrCodeScanListener) {
        try {
     ...
     * @param qrCodeScanListener QRCodeScanListenerMod to give callbacks to app.
     */
    private void isDeviceAvailable(final ESPDeviceMod device, String password, QRCodeScanListenerMod qrCodeScanListener) {
    ...
    class SearchDeviceTask implements Runnable {
        ...
        private ESPDeviceMod device;
        private QRCodeScanListenerMod listener;
        private String password;

        SearchDeviceTask(ESPDeviceMod device1, String password1, QRCodeScanListenerMod listener1) {
            searchCnt++;
            device = device1;
            listener = listener1;
            password = password1;
