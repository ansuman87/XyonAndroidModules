 ...
 */
public class ESPDeviceMod {

    private static final String TAG = "ESP:" + ESPDeviceMod.class.getSimpleName();
    ...
    public ESPDeviceMod(Context context, ESPConstants.TransportType transportType, ESPConstants.SecurityType securityType) {
    ...
    public void scanNetworks(final WiFiScanListener wifiScanListener) {
        ...
        if (session == null || !session.isEstablished()) {
            ...
            Log.d(TAG, "scanNetworks: Initializing new session...");
    ...
    public void provision(final String ssid, final String passphrase, final ProvisionListener provisionListener) {
        ...
        if (session == null || !session.isEstablished()) {
            ...
            Log.d(TAG, "provision: Initializing new session...");
            ...
            initSession(new ResponseListener() {
                ...
                public void onFailure(Exception e) {
                    e.printStackTrace();
//                    disableOnlyWifiNetwork();    // Modified by Ansuman
...
//                    disableOnlyWifiNetwork();   // Changed by Ansuman
                }
            }
...
//                    session = null;               // Changed by Ansuman
//                    disableOnlyWifiNetwork();     // Changed by Ansuman
...
//                disableOnlyWifiNetwork();         // Changed by Ansuman
    ...
    // Added by Ansuman
    public void closeSessionAndDisableWifiNetwork() {
        session = null;
        disableOnlyWifiNetwork();
    }
}
